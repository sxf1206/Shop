					...
					<view class="contentInfo">
						...
						<view class="yt-list">
							...
							<view class="yt-list-cell b-b">
								...
								<text class="cell-tip active" style="color: #333;font-size: 16px;" v-if="VIPType==0">￥{{SalePrice}}</text>
								<text class="cell-tip active" style="color: #333;font-size: 16px;" v-if="VIPType!=0">￥{{BackMoney}}</text>
							</view>
						</view>
								...
								<view class="cell-tit clamp">
									...
									<view style="width: 100%;margin-top: 10px;">
										<textarea style="width: 93%;height: 44px;padding: 12px;background-color: #DDDDDD;border-radius:8px ;"
										 placeholder="必填" maxlength="500" @input="blur" value=""></textarea>
									</view>
								</view>
							</view>
							<view class="yt-list-cell b-b">
...
<script>
	...
	export default {
		...
		data() {
			return {
				msgContents: ["拒收", "少件/漏发", "物流停滞/签收异常", "快递无物流记录", "多拍/拍错/不想要", "生鲜变质退款"],
				GoodsList: [],
				OrderNo: "",
				GoodsNo: "",
				OrderGuid: "",
		...
		methods: {
			...
			AddReturnres() {
				...
				console.log(this.OrderNo + ":" + this.OrderGuid + ":" + this.GoodsNo + ":" + this.Account + ":" + this.BackMoney +
					":" + this.BackReason + ":" + this.remarkinfo + ":" + this.EorrorPic + ":" + this.ReturnType);
